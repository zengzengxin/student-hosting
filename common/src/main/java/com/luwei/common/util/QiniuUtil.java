...
public class QiniuUtil {
    ...
    private static String accessKey="-3X6fxwlWWCz1BjRHzhX-uCqwnSBOtLncaIYMVe6";

    private static String secretKey="gg5Eb-fjwIqzfjLNoDgwOdtwIzuyiEvXD0PnORoQ";

    private static String bucket="blogs-pic";

    private static String path="http://image.talkmoney.cn/";
